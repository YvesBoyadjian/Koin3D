...
import jsceneviewerawt.inventor.qt.SoQtEventHandler;
...
public class SoQtDevice {
	...
	public static SoType getClassTypeId() { return new SoType(classTypeId); }
	  ...
	  classTypeId.copyFrom( SoType.createType(parentClassTypeId,   
	    ...
	    public void        enable(Component widget, SoQtEventHandler handler,
								  Object closure) {}
	    public void        disable(Component widget, SoQtEventHandler handler,
	                                Object closure) {}
	  ...
	  public SoEvent  translateEvent(ComponentEvent qevent, EventType type) { return null; }

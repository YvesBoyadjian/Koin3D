...
import jsceneviewerawt.QSlider;
...
public class SoQtFullViewer extends SoQtViewer {
	...
	public
	    ...
	    protected Container        leftTrimForm;
	    protected Container        bottomTrimForm;
	    protected Container        rightTrimForm;

	    // viewer button container
	    protected JToolBar viewerButtonBar;

	    private final SbVec2fSingle         zoomSldRange = new SbVec2fSingle();
	    
	    // zoom pref sheet
	    private Container      zoomPrefSheet;
	    private QSlider        zoomSlider;
	    private QDoubleSpinBox zoomInput;

	    // viewer toolbar actions
	    private JCheckBox        pickAction;
	    private JCheckBox        viewAction;
	    private JCheckBox        seekAction;
	    ...
	    {
	        // pre-create actions
	        pickAction = new JCheckBox(
	        		new AbstractAction("Pick mode", SoQtIcons.getIcon (SoQtIcons.IconNum.ICON_PICK)) {
					@Override
	        ...
	        viewAction = new JCheckBox(
	        		new AbstractAction("View mode", SoQtIcons.getIcon (SoQtIcons.IconNum.ICON_VIEW)) {
					@Override
					public void actionPerformed(ActionEvent e) {
			...
			pickAction.setSelected(!isViewing());
			viewAction.setSelected(isViewing());
...
//	            helpAction2.setVisible (helpClientCount > 0);
	            ...
	            seekAction = new JCheckBox(
	            		new AbstractAction("Seek mode",SoQtIcons.getIcon (SoQtIcons.IconNum.ICON_SEEK)) {
						@Override
						public void actionPerformed(ActionEvent e) {
	            ...
	            seekAction.setSelected(getCameraController().isSeekMode());

	            gotoHomeAction =
	                new AbstractAction("Goto home position", SoQtIcons.getIcon (SoQtIcons.IconNum.ICON_HOME)) {
						@Override
						public void actionPerformed(ActionEvent e) {
	            ...
	            setHomeAction =
	                new AbstractAction ("Set home position", SoQtIcons.getIcon (SoQtIcons.IconNum.ICON_SET_HOME)) {
						@Override
						public void actionPerformed(ActionEvent e) {
	            ...
	            viewAllAction =
	                new AbstractAction("View all",SoQtIcons.getIcon (SoQtIcons.IconNum.ICON_VIEW_ALL)) {
						@Override
						public void actionPerformed(ActionEvent e) {
...
public void setViewing (boolean flag)
{
    ...
    viewAction.setSelected(viewingFlag);
    pickAction.setSelected(!viewingFlag);
...
protected void hideEvent ()
{
    ...
    if (prefSheetDialog != null) {
        prefSheetDialog.setVisible(false);
    }
}
...
protected Container createRightBorder (Container parent)
{
    rightTrimForm = new Container ();
    parent.add(rightTrimForm);
    BoxLayout box = new BoxLayout(rightTrimForm,BoxLayout.Y_AXIS);
    //box.marginHeight = 2;
    //box.marginWidth = 2;
    rightTrimForm.setLayout (box);
    viewerButtonBar = new JToolBar ("rightTrimForm",JToolBar.VERTICAL);
    rightTrimForm.add(viewerButtonBar);
//#if defined(MACOS)

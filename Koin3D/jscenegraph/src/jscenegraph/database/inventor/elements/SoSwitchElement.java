 ...
 *
 */
public class SoSwitchElement extends SoInt32Element {

    //! Sets the current switch index in the state
  public    static void         set(SoState state, int index)
           { SoInt32Element.set(classStackIndexMap.get(SoSwitchElement.class), state, index); }
   	
    //! Returns current switch index from the state
  public     static int              get(SoState state)
           { return SoInt32Element.get(classStackIndexMap.get(SoSwitchElement.class), state); }

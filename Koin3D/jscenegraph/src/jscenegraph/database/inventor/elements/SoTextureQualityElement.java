...
////////////////////////////////////////////////////////////////////////
{
	...
	public static void         set(SoState state, float qual)
        { SoFloatElement.set(classStackIndexMap.get(SoTextureQualityElement.class), state, qual); }

    //! Returns current TextureQuality from the state
	public static float        get(SoState state)
        { return SoFloatElement.get(classStackIndexMap.get(SoTextureQualityElement.class), state); }

...
public class SoLightAttenuationElement extends SoReplacedElement {
  ...
  protected
    final SbVec3f             attenuation = new SbVec3f();

  //! Returns the default light attenuation
  public static SbVec3f      getDefault()            { return new SbVec3f(0.f, 0.f, 1.f); }
...
////////////////////////////////////////////////////////////////////////
{
    attenuation.copyFrom(getDefault());
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    elt = (SoLightAttenuationElement )
        getElement(state, classStackIndexMap.get(SoLightAttenuationElement.class), node);

    if (elt != null)
        elt.attenuation.copyFrom(attenuation);
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    elt = (SoLightAttenuationElement )
        getConstElement(state, classStackIndexMap.get(SoLightAttenuationElement.class));
...
{
    return (attenuation ==
            (( SoLightAttenuationElement ) elt).attenuation);
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    result.attenuation.copyFrom(attenuation);

 ...
 *
 */
public class SoGLRenderPassElement extends SoElement {
...
{
    return (GLRenderPass ==
            (( SoGLRenderPassElement ) elt).GLRenderPass);
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    elt = (SoGLRenderPassElement ) getElement(state, classStackIndexMap.get(SoGLRenderPassElement.class));
...
////////////////////////////////////////////////////////////////////////
{
    final SoGLRenderPassElement elt;

    elt = ( SoGLRenderPassElement )
        getConstElement(state, classStackIndexMap.get(SoGLRenderPassElement.class));

...
SoSFShorts are written to file as a single short integer
...
public class SoSFShort extends SoSField<Short> {
	...
	/* (non-Javadoc)
	 * @see jscenegraph.database.inventor.fields.SoSField#readValue(jscenegraph.database.inventor.SoInput)
	 */
	@Override

 ...
 *
 */
public class SoV2Text2 extends SoUpgrader {

	/* (non-Javadoc)
	 * @see jscenegraph.database.inventor.misc.upgraders.SoUpgrader#createNewNode()
	 */
	@Override
	SoNode createNewNode() {
    ...
    public static boolean         convertToUTF8(final String inString, 

 ...
 *
 */
public class SoLineWidthElement extends SoFloatElement {
...
////////////////////////////////////////////////////////////////////////
{
    ...
    public static void         set(SoState state, float width)
        { SoFloatElement.set(classStackIndexMap.get(SoLineWidthElement.class), state, width); }

    //! Returns current line width from the state
    public static float        get(SoState state)
        { return SoFloatElement.get(classStackIndexMap.get(SoLineWidthElement.class), state); }

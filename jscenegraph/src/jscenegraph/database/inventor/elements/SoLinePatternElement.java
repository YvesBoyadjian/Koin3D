 ...
 *
 */
public class SoLinePatternElement extends SoInt32Element {
...
////////////////////////////////////////////////////////////////////////
{
    ...
    public static void         set(SoState state, short pattern)
        { SoInt32Element.set(classStackIndexMap.get(SoLinePatternElement.class), state, (int)pattern); }

    //! Returns current line pattern from the state
    public static short      get(SoState state)
        { return (short)SoInt32Element.get(classStackIndexMap.get(SoLinePatternElement.class), state); }

    //! Returns the default line pattern
    public static short      getDefault()                    { return (short)0xffff; }

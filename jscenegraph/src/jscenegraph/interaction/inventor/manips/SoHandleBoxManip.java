...
import jscenegraph.interaction.inventor.draggers.SoHandleBoxDragger;
...
The interface for an SoHandleBoxManip is exactly the same as that
of the SoHandleBoxDragger.  
To find out more about the interface, see the reference page 
for SoHandleBoxDragger.  To find out how the manipulator uses a 
...
public class SoHandleBoxManip extends SoTransformManip {

	private final SoSubNode nodeHeader = SoSubNode.SO_NODE_HEADER(SoHandleBoxManip.class,this);
	   
	   public                                                                     
	    static SoType       getClassTypeId()        /* Returns class type id */   
	                                    { return SoSubNode.getClassTypeId(SoHandleBoxManip.class);  }                   
	  ...
	  public  static SoFieldData[] getFieldDataPtr()                              
	        { return SoSubNode.getFieldDataPtr(SoHandleBoxManip.class); }    	  	
...
//    Constructor
//
public SoHandleBoxManip()
//
////////////////////////////////////////////////////////////////////////
{
    nodeHeader.SO_NODE_CONSTRUCTOR(/*SoHandleBoxManip.class*/);
...
////////////////////////////////////////////////////////////////////////
{
    SO__NODE_INIT_CLASS(SoHandleBoxManip.class, "HandleBoxManip", SoTransformManip.class);
}
